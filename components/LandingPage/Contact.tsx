                ...
                <div className="lg:flex bg-third px-4 py-2 lg:px-8 lg:py-4">
                    ...
                    <div className="w-full lg:w-1/2 space-y-4 lg:space-y-8 px-4 py-4 lg:px-8 lg:py-4">
                        ...
                        <div className="relative">
                            <input type="text" placeholder="Input" className='w-full py-2 px-5 text-base text-white bg-third border-secondary border rounded-md outline-none placeholder-third placeholder-opacity-0 transition duration-200'/>
                            <span className='text-sm bg-third absolute left-6 top-3 px-1 transition duration-200 input-text'>
                                Name
                            </span>
                        </div>
                        <div className="relative">
                            <input type="email" placeholder="Input" className='w-full py-2 px-5 text-base text-white bg-third border-secondary border rounded-md outline-none placeholder-third placeholder-opacity-0 transition duration-200'/>
                            <span className='text-sm bg-third absolute left-6 top-3 px-1 transition duration-200 input-text'>
                                Email
                            </span>
                        </div>
                        <div className="relative">
                            <textarea typeof='text' rows={4} placeholder="Input" className='w-full py-2 px-5 text-base text-white bg-third border-secondary border rounded-md outline-none placeholder-third placeholder-opacity-0 transition duration-200'/>
                            <span className='text-sm bg-third absolute left-6 top-3 px-1 transition duration-200 input-text'>
                                Message
                            </span>
                        </div>
                        <div className="w-full lg:w-1/2 flex justify-end">
                            <button className='px-10 py-2 tracking-widest bg-secondary text-black rounded-md'>
                                Send
                            </button>
                        </div>
                    </div>
