        ...
        <>
            <Header/>
                <div className="bg-white font-inter">
                    <div className="w-full 2xl:w-10/12 lg:mx-auto lg:flex px-4 lg:px-8 py-20 mt-16">
                        ...
                        <div className="w-full lg:w-2/3 h-pict bg-primary px-4 lg:px-8 2xl:px-14 py-6 my-8 lg:my-0">
                            <div className="flex justify-end text-white">
                                <span className="flex items-center text-base font-light tracking-widest">
                            ...
                            <div className="pt-8 lg:pt-20">
                                <button onClick={saveFile} className="px-4 py-2 w-full lg:w-auto flex justify-center items-center bg-white text-primary rounded-md tracking-wider">
                                    Download Resume
                                    <ArrowDownTrayIcon className="h-5 w-5 ml-2" fill="none" stroke="currentColor"/>
                                </button>
                            </div>
                        </div>
                    </div>
